                    ...
                    <div class="scrollbar-sidebar">
                        <div class="app-sidebar__inner">
                            <ul class="vertical-nav-menu">
                                ...
                                <li>
                                    <a href="main.php" class="<?php if($NamePage=='main'){ echo 'mm-active';}?>">
                                        <i class="metismenu-icon pe-7s-diskette"></i> บันทึกข้อมูลการแจ้งงาน
                                    </a>
                                </li>   
                                <li>
                                    <a href="department.php" class="<?php if($NamePage=='department'){ echo 'mm-active';}?>">
                                        <i class="metismenu-icon pe-7s-network"></i> ข้อมูลแผนก
                                    </a>
                                </li>  
                                <li>
                                    <a href="report.php" class="<?php if($NamePage=='report'){ echo 'mm-active';}?>">
                                        <i class="metismenu-icon pe-7s-graph3"></i> รายงานบันทึกการแจ้งงาน
                                    </a>
                                </li>              
                            </ul>                         
                        </div>
